...
enum saturation_axiom_type {
	SUBSUMPTION_CONJUNCTION_INTRODUCTION, SUBSUMPTION_EXISTENTIAL_INTRODUCTION_1, SUBSUMPTION_EXISTENTIAL_INTRODUCTION_2, SUBSUMPTION_EXISTENTIAL_DECOMPOSITION, SUBSUMPTION_INITIALIZATION, SUBSUMPTION_TOLD_SUBSUMER, SUBSUMPTION_CONJUNCTION_DECOMPOSITION,
