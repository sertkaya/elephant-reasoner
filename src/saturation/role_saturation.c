...
void saturate_roles(KB* kb) {
   ...
   // the object properties
	...
	while (object_property_chain != EXPRESSION_ID_NULL) {
		...
		while (subsumee_1 != EXPRESSION_ID_NULL) {
			...
			while (subsumee_2 != EXPRESSION_ID_NULL) {
					// new object property chain
					ObjectPropertyExpressionId new_composition = get_create_role_composition_binary(
							(ObjectPropertyExpressionId) subsumee_1,
							(ObjectPropertyExpressionId) subsumee_2,
							kb->tbox);
