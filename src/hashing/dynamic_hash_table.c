...
extern inline char dynamic_hash_table_insert(void* key, DynamicHashTable* hash_table);

extern inline char dynamic_hash_table_contains(void* key, DynamicHashTable* hash_table);

extern char dynamic_hash_table_remove(void* key, DynamicHashTable* hash_table);
 ...
 */
extern inline void* dynamic_hash_table_iterator_next(DynamicHashTableIterator* iterator);
