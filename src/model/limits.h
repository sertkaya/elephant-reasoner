...
#define DEFAULT_FIRST_CONJUNCT_OF_HASH_SIZE			8
#define DEFAULT_SECOND_CONJUNCT_OF_HASH_SIZE		8
#define DEFAULT_SUBSUMERS_HASH_SIZE					8
#define DEFAULT_DIRECT_SUBSUMERS_SET_SIZE			8
#define DEFAULT_EQUIVALENT_CONCEPTS_SET_SIZE		8
#define DEFAULT_PREDECESSORS_SET__SIZE		8
#define DEFAULT_SUCCESSORS_SET__SIZE		8
