...
#define DEFAULT_SUBCLASSOF_AXIOMS_SET_SIZE						1024
#define DEFAULT_EQUIVALENTCLASSES_AXIOMS_SET_SIZE				1024
#define DEFAULT_SUBOBJECTPROPERTYOF_AXIOMS_SET_SIZE				128
#define DEFAULT_TRANSITIVEOBJECTPROPERTY_AXIOMS_SET_SIZE		128
#endif
